...
,
  ...
  projectArchitecture: {
    description: [
      ...
      'Three-Table MySQL Structure (Database Layer): Data is stored in a structured MySQL database across three separate tables, mirroring the input sheets for organization and scalability.'
    ]
  },
