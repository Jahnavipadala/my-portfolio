...
// Helper to convert **bold** markdown to <strong>
      ...
      >
        ...
        <div
          className={`sticky top-0 ${
            isDarkMode ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"
          } p-4 border-b flex justify-between items-center rounded-t-xl z-10`}
        >
          ...
          {project.projectArchitecture && (
            <div className="animate-slide-in">
              ...
              <div className="space-y-4">
                ...
                {/* Bullet Details */}
                {Array.isArray(project.projectArchitecture.description) ? (
                  <ul className="list-disc pl-6 space-y-3">
                    {project.projectArchitecture.description.map(
                      (point, index) => (
                        <li
                          key={index}
                          className={`${
